...
const textareaClass =
  'border-0 outline-none focus:outline-none focus:ring-0 active:ring-0 active:outline-none bg-transparent'
const ArrowUpClass =
  'flex justify-center items-center h-[32px] w-[32px] rounded-[50%]  text-[#fff]'
