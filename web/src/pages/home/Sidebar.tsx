...
// 个人信息变量
const userInfoDropdownMenuClass =
  'flex items-center  cursor-pointer hover:bg-[#f5f5f5] '
      ...
      items: [
        {
          ...
          Des: '文本, 手机号码, 字符串',
          style: '文本',
          SelectItems: [{ id: 'phone', text: '138****8293' }]
        },

        {
          ...
          Des: '按钮, 用户协议页面路由, 字符串',
          style: '按钮',
          SelectItems: [{ id: 'src', text: 'https://www.baidu.com' }]
        },
        {
          id: 'privacyPolicy',
          text: '隐私政策',
          Des: '按钮, 隐私政策页面路由, 字符串',
          style: '按钮',
          SelectItems: [{ id: 'src', text: 'https://hm.dh-data.com' }]
        },
        {
          id: 'cancelAccount',
          text: '注销账号',
      ...
      <div className="ml-[10px] mr-[10px]">
        <DropdownMenu>
          <DropdownMenuTrigger className="w-full " asChild>
            <div className="cursor-pointer p-[10px] outline-none rounded-[12px] hover:bg-[var(--bg-color-hover)] flex items-center">
              <div>
                <img
                  ...
                  <React.Fragment key={item.id}>
                    <div className="flex items-center justify-between h-14">
                      ...
                      {item.style === '按钮' ? (
                        ...
                        >
                          {item.id === 'cancelAccount' ? '注销' : '查看'}{' '}
                          {/* 注销账号按钮显示“注销”，其他按钮显示“查看” */}
                        </button>
                      ) : (
